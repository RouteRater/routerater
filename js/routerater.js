...
RouteRater.prototype.makeMap = function(){
	...
	if(typeof L==="object"){
		...
		this.layers.base["Route rater calm"] = L.tileLayer('http://www.strudel.org.uk/routerater/oldtiles/{z}/{x}/{y}.png', {
	...
	$(document).on('click','#gradedescriptiontoggle',function(e){ $('.togglekey').trigger('click'); })
